  ...
  if (currentStage === 1)
    return (
      <h1 className='sm:text-l sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5'>
        Hi, I am
        <span className='font-bold mx-1 text-white text-lg tracking-wide'>Yash D</span>
  ...
  if (currentStage === 2) {
    return (
      <div className='info-box'>
        ...
        Worked with established organizations <br />gaining valuable skills and insights through diverse professional experiences
        </p>
